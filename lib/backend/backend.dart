...
import 'schema/instagram_post_record.dart';
...
export 'schema/instagram_post_record.dart';
...
/// Functions to query InstagramPostRecords (as a Stream and as a Future).
Stream<List<InstagramPostRecord>> queryInstagramPostRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      InstagramPostRecord.collection,
...
Future<List<InstagramPostRecord>> queryInstagramPostRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<InstagramPostRecord>> queryInstagramPostRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
